...
\usepackage{amsmath, amssymb, blindtext, bm, calc, caption, float, hyperref, icomma, lmodern, makecell, multibib, multicol, parskip, pgfplots, steinmetz, tabularray, tikz, tikz-3dplot, varwidth, wrapfig2, xcolor, xparse, xeCJK}
...
\NewDocumentCommand{\solution}{o}{
   ...
   \IfNoValueTF{#1}
      ...
      {\noindent\textbf{Lời giải bài~\ref{ex:#1}}:}
   \IfNoValueTF{#1}
...
\nociteMath{*}
\nocitePhys{*}
\addcontentsline{toc}{chapter}{Tài liệu tham khảo - Toán}
\bibliographystyleMath{plain}
\bibliographyMath{ref_math}
\addcontentsline{toc}{chapter}{Tài liệu tham khảo - Vật lí}
