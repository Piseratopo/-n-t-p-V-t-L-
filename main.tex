...
\usepackage{amsmath, amssymb, blindtext, bm, calc, caption, float, hyperref, icomma, makecell, multicol, pgfplots, steinmetz, tikz, tikz-3dplot, wrapfig2, xcolor, xparse, xeCJK}

% Tinh chỉnh Tikz
\usetikzlibrary{arrows.meta, calc, decorations.pathmorphing, intersections, pgfplots.fillbetween, shadings}
\tikzset{snake it/.style={decorate, decoration=snake, thick}}
