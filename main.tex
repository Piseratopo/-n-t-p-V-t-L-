...
\usepackage{amsmath, amssymb, blindtext, bm, calc, caption, float, hyperref, icomma, lmodern, makecell, multibib, multicol, multirow, pgfplots, steinmetz, tabularray, tikz, tikz-3dplot, varwidth, wrapfig2, xcolor, xparse, xeCJK}
...
\newcommand{\notimpliedby}{\text{\hspace{0.8em}$\not$\hspace{-0.85em}$\impliedby$}}
