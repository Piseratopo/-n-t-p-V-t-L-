...
\usepackage{amsmath, amssymb, blindtext, calc, caption, float, hyperref, icomma, makecell, multicol, steinmetz, tikz, tikz-3dplot, wrapfig, xcolor, xparse, xeCJK}
...
\input{\chapdir toan_hoc_nen_tang/ham_so.tex} 
