...
\usepackage{amsmath, amssymb, blindtext, calc, hyperref, icomma, multicol, steinmetz, tikz, tikz-3dplot, wrapfig, xcolor, xparse, xeCJK}
...
\begin{figure}[h]
   ...
   \begin{minipage}[b]{0.48\textwidth}
      ...
      \begin{tikzpicture}[tdplot_main_coords]
         ...
         % Vẽ tên các góc phần tám không gian
