...
\usepackage{amsmath, amssymb, blindtext, bm, calc, caption, float, hyperref, icomma, lmodern, makecell, multibib, multicol, pgfplots, steinmetz, tabularray, tikz, tikz-3dplot, varwidth, wrapfig2, xcolor, xparse, xeCJK}
...
\newcommand{\emphcolor}[1]{\textcolor{colorEmphasisCyan}{\emph{#1}}}
