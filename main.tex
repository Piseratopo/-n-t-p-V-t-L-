...
\begin{figure}[H]
   ...
   \begin{tikzpicture}[tdplot_main_coords]
      ...
      \filldraw (1,2,3) circle (2pt) node[anchor=west] {$A(1;2;3)$};
      \filldraw (-1,0,4) circle (2pt) node[anchor=east] {$B(-1;0;4)$};
      \filldraw (0,1,3.5) circle (2pt) node[anchor=south west] {$M(0;1;\frac{7}{2})$};
...
\exercise[intropt] Vẽ đồ thị của phương trình $\mathcal{P}$, với các định nghĩa được cho. Để ý đến số ẩn trong $\mathcal{P}$ để lựa chọn đồ thị phù hợp.

\begin{enumerate}
   \item $\mathcal{P}: x^2 - 1 = 0$ với $x$ là ẩn thực;
   \item
   ...
   \begin{tabular}{|c|c|c|c|c|c|c|}
      ...
      $f(x)$ & $2$ & $3$ & $5$ & $7$ & $11$ & $13$\\
      \hline
   \end{tabular} và $\mathcal{P}: f(x) = 2b-1$ với $b$ là ẩn thực;
...
\begin{wrapfigure}{r}{0.5\textwidth}
   ...
   \begin{tikzpicture}
      ...
      \filldraw (2, 0) circle (2pt) node[below] {$2$};
      \filldraw (3, 0) circle (2pt) node[below] {$3$};
      \filldraw (4, 0) circle (2pt) node[below] {$4$};
...
\begin{figure}[h]
   ...
   \begin{tikzpicture}
      ...
      \filldraw (1, 1) circle (2pt) node[right] {$(2; 2)$};
      \filldraw (1.5, 1.5) circle (2pt) node[right] {$(3; 3)$};
      \filldraw (2.5, 3) circle (2pt) node[right] {$(5; 6)$};
      \filldraw (2, 2) circle (2pt) node[right] {$(4; 4)$};
   \end{tikzpicture}
