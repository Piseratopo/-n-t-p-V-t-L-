...
Mệnh đề phức ``$P$ tuyển $Q$'' có kí hiệu $\defMath{P \lor Q}$. Mệnh đề này đúng khi tối thiểu một trong hai mệnh đề đầu vào đúng, và chỉ sai khi cả hai mệnh đề đầu vào đều sai. Bảng \ref{tab:nen_tang_lo_gich:giai_tich_menh_de:menh_de_phuc_hop:dn_tuyen} cho giá trị chân lí của mệnh đề tuyển.
\begin{table}[H]
   \centering
