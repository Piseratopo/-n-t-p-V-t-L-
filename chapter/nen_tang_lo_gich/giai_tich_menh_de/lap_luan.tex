...
\subsection{Yêu cầu cho lập luận lô-gích}

\ % Lùi đầu dòng

Quá trình lập luận lô-gích được kiểm soát bởi những bộ quy luật hết sức đơn giản, đơn giản tới mức mà cả tác giả và bạn đọc đều có thể và đã từng làm theo. Mặc dù vậy, có rất nhiều yêu cầu về mặt kĩ thuật cần phải quan tâm khi xây dựng một bộ quy luật lập luận mà khuôn khổ cuốn sách này không có khả năng đề cập. Tác giả sẽ chỉ đưa ra các yêu cầu cơ bản nhưng quan trọng nhất khi lập luận lô-gích diễn dịch:
\begin{enumerate}
...
Qua đó, chúng ta có điều phải chứng minh. Bạn đọc cũng có thể thực hiện bài tập này thông qua bảng giá trị chân lí, nhưng khi đó, bạn đọc sẽ phải xét\dots\ mà thôi, bạn đọc có thể tham khảo bảng \ref{ex:nen_tang_lo_gich:giai_tich_menh_de:lap_luan:bai_2_phan_4} nếu bạn đọc không muốn phải ghét bản thân như tác giả đã từng khi thực hiện lập bảng này\footnote{Bạn đọc có thể kiểm tra lại bảng \ref{ex:nen_tang_lo_gich:giai_tich_menh_de:lap_luan:bai_2_phan_4} để trải nghiệm cảm giác của tác giả lúc viết đáp án. Khi càng tăng nhiều biến thì số trường hợp cần phải kiểm tra cũng tăng theo cấp số nhân.}. Ngoài ra, bạn đọc cũng sẽ mất đi cơ hội được thường thức nghệ thuật của sự lập luận do bị thay thế bởi sự cơ học của phương pháp.
