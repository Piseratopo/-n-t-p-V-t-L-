...
\begin{equation}
    ...
    \label{eq:nen_tang_lo_gich:giai_tich_vi_tu_bac_nhat:2.1}
\end{equation}
...
\begin{equation}
    ...
    \label{eq:nen_tang_lo_gich:giai_tich_vi_tu_bac_nhat:2.2}
\end{equation}
Hội giữa \refeq{eq:nen_tang_lo_gich:giai_tich_vi_tu_bac_nhat:2.1} và \refeq{eq:nen_tang_lo_gich:giai_tich_vi_tu_bac_nhat:2.2}, thông qua tính chất phân phối,
\begin{equation*}
