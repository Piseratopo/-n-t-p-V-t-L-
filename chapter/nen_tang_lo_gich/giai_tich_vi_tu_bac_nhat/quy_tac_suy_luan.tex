...
\begin{align*}
    ...
    & \big(V_=(x, y) \lor V_<(x, y) \iff (V_\le(x, y) \lor \neg V_\le(y, x)) \land (V_<(y, x) \land \neg V_\le(y, x))\big) \equationexplanation{tính chất phân phối};\\
    G &\implies \forall x, \forall y, (V_=(x, y) \lor \neg V_\le(y, x)) \equationexplanation{tính chất không mâu thuẫn và đồng nhất với phép tuyển}.
\end{align*}
