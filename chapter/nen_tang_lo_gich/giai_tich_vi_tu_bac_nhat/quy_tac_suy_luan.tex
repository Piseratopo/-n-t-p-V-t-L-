...
\begin{enumerate}
    ...
    \item $\forall x, A(x) \lor \forall y, B(y) \iff \forall x, \forall y, \left(A(x) \lor B(y)\right)$ (quy tắc chuyển đổi lượng từ phổ quát);
    \item $\exists x, A(x) \land \exists y, B(y) \iff \exists x, \exists y, (A(x) \land B(y))$ (quy tắc chuyển đổi lượng từ tồn tại);
\end{enumerate}
...
\stepcounter{subexercise}
\arabic{subexercise}. Chứng minh chiều xuôi, giả sử có $\exists x, A(x) \land \exists y, B(y)$. Điều này dẫn đến có hai hạng thức $c$ và $d$ thỏa mãn $A(c) \land B(d)$. Và đương nhiên, theo quy tắc tồn tại hóa
\begin{align*}
    A(c) \land B(d) &\implies \exists x, (A(x) \land B(d)); \\
    A(c) \land B(d) &\implies \exists x, \exists y, (A(x) \land B(y)).
\end{align*}

Chiều xuôi đã được khẳng định. Để khẳng định được chiều ngược lại, chúng ta cũng đưa ra nhận định rằng phải có $c$ và $d$ thỏa mãn $A(c) \land B(d)$ nếu có $\exists x, \exists y, (A(x) \land B(y))$. Và khi đó, hiển nhiên có
\begin{equation*}
    \begin{cases}
        A(c) \\
        B(d)
    ...
    \end{cases}
\end{equation*}
theo quy tắc tồn tại hóa. Do vậy $\exists x, \exists y, (A(x) \land B(y)) \implies \exists x, A(x) \land \exists y, B(y)$.
...
\begin{equation*}
    \begin{cases}
        ...
        \forall x, \forall y, \forall z, \big(V_\le(x; y) \land V_\le(y; z) \iff V_\le(z; x)\big)
    \end{cases}.
\end{equation*}
...
Qua đó, chúng ta có mẫu thuẫn $V_\le(x; y) \land V_<(y; z) \land V_\le(z; x)$ với mọi $x$, $y$ và $z$. Theo chứng minh bằng phản chứng, chúng ta phải có $\neg V_\le(z; x)$ hay $V_<(x; z)$ nếu có giả thiết $V_\le(x; y) \land V_<(y,z)$. Nói cách khác, từ phản chứng,
$$
...
\end{align*}
Theo chứng minh bẳng phản chứng, dễ thấy có điều phải chứng minh.