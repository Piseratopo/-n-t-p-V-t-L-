...
\subsection{Quy tắc tồn tại hóa}

\ 

Bất cứ khi nào chúng ta nói rằng ``tồn tại một $x$ thỏa mãn một tính chất $A(x)$ nào đó'', điều đó có nghĩa rằng $x$ có thể là một $c$ nào đó có tính chất $A(c)$. Chúng ta không biết, và cũng không cần phải biết, $c$ có hình thù ra làm sao, tên tuổi như thế nào. Chúng ta chỉ cần biết là có một $c$, hay một $x$ thỏa mãn tính chất đã cho và chúng ta có thể tìm thêm những tính chất mới trên vật chất $c$ mới đó.
...
\begin{equation}
    \forall x, \forall y, \forall z, (V_\le(z; y) \land V_\le(y; x) \implies V_\le(z; x)).
...
\begin{equation*}
    \forall x, \forall y, \forall z, (V_=(x; y) \land V_=(y; z) \iff V_=(x; z)).
\end{equation*}
Điều phải chứng minh.
