...
Với $a; b \in \mathbb{R}$ sao cho $a \leq b$, định nghĩa chín loại \defText{khoảng}:
...
\begin{table}[H]
   ...
   \begin{tabular}{|c|c|}
      ...
      \textbf{Khoảng} & \textbf{Biểu diễn trên trục số} \\
      \hline
      \rangeParbox{$\defMath{\left(-\infty; a\right] = \left]-\infty; a\right] = \left\{x \in \mathbb{R} : x \leq a\right\}}$} & \rangeParbox{
         \begin{tikzpicture}
            \draw[->] (-3, 0) -- (3, 0);
            \draw[graph thickness,color=colorEmphasisCyan] (-3, 0) -- (1.8, 0);
            \filldraw[color=colorEmphasisCyan] (1.8, 0) circle (\pointSize) node[below] {$a$};
         \end{tikzpicture}
      } \\
      \hline
      \rangeParbox{$\defMath{\left(-\infty; a\right) = \left]-\infty; a\right[ = \left\{x \in \mathbb{R} : x < a\right\}}$} & \rangeParbox{
         \begin{tikzpicture}
            \draw[->] (-3, 0) -- (3, 0);
            \draw[graph thickness,color=colorEmphasisCyan] (-3, 0) -- (1.8, 0);
            \filldraw[color=colorEmphasisCyan, hollow point] (1.8, 0) circle (\pointSize) node[below] {$a$};
         \end{tikzpicture}
      } \\
      \hline
   \end{tabular}
...
\begin{itemize}
   \item $\defMath{\left[a; +\infty\right) = \left[a; +\infty\right[ = \left\{x \in \mathbb{R} : x \geq a\right\}}$;
   \item $\defMath{\left(a; +\infty\right) = \left]a; +\infty\right[ = \left\{x \in \mathbb{R} : x > a\right\}}$;
   \item $\defMath{\left(-\infty; +\infty\right) = \left]-\infty; +\infty\right[ = \mathbb{R}}$;
\end{itemize}
