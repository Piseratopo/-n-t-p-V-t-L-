...
\begin{itemize}
   \item $\defMath{\left[a; b\right] = \left\{x \in \mathbb{R} : a \leq x \leq b\right\}}$, còn có tên là ;
   \item $\defMath{\left[a; b\right) = \left[a; b\right[ = \left\{x \in \mathbb{R} : a \leq x < b\right\}}$;
