...
\begin{itemize}
   \item $A(2;3)$: $x>0$, $y>0 \implies$ \fbox{$A$ thuộc góc phần tư thứ I};
   \item $B(-1;2)$: $x<0$, $y>0 \implies$ \fbox{$B$ thuộc góc phần tư thứ II};
   \item $C(-3;0)$: $x<0$, $y=0 \implies$ \fbox{$C$ thuộc trục hoành};
   \item $D(0;4)$: $x=0$, $y>0 \implies$ \fbox{$D$ thuộc trục tung};
\end{itemize}
