...
\begin{figure}[H]
   ...
   \begin{minipage}[b]{0.48\textwidth}
      ...
      \begin{tikzpicture}
         ...
         \draw[\guideLineThickness] (\xP, \yP) -- ({\xP - \leftShift}, {\yP - \upShift});
         \draw[\guideLineThickness] (\xQ, \yQ) -- ({\xQ - \leftShift}, {\yQ - \upShift});
         ...
         \draw[<->, >=latex, shorten >=\pointSize, shorten <=\pointSize, color=colorEmphasisCyan] ({\xP - \leftShift / 2}, {\yP - \upShift / 2}) -- ({\xQ - \leftShift / 2}, {\yQ - \upShift / 2});
