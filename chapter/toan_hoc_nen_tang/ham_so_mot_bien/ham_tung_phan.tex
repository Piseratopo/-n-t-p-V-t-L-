...
Đầu tiên, chúng ta sẽ chứng minh $n \leq x < n + 1 \iff \lfloor x \rfloor = n$. Chứng minh chiều xuôi, giả sử $n \leq x < n + 1$. Gọi $M_m$ là tập hợp các số nguyên không vượt quá $x$. Rõ ràng rằng $M_m$ khác rỗng, do có $n$ làm phần tử. Ngoài ra, mọi số nguyên $a > n$ không làm phần tử của $M_m$ vì $a > n \iff a \geq n + 1 \implies a > x$. Kết hợp lại, mọi phần tử $b$ trong $M_m$ phải thỏa mãn $b \leq n$. Do đó, $n$ là số nguyên lớn nhất không vượt quá $x$, hay $\lfloor x \rfloor = n$.
