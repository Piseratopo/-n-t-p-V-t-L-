...
\begin{figure}[H]
   ...
   \label{fig:toan_hoc_nen_tang:ham_so_mot_bien:ham_tung_phan:bdtkho_2}
\end{figure}
...
\stepcounter{subexercise}
\arabic{subexercise}. Nếu chúng ta nhìn vào đồ thị hình \ref{fig:toan_hoc_nen_tang:ham_so_mot_bien:ham_tung_phan:bdtkho_2}, sẽ có được ngay bất phương trình này đúng với mọi $x$ thực. Bất đẳng thức này cũng có thể được chứng minh bằng phương pháp đại số như sau: Để ý rằng,
$$
