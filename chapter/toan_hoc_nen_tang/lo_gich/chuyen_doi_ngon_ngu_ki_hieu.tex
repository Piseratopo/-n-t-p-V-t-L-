...
\begin{enumerate}
    ...
    \item ``Chỉ khi cô bé quàng khăn đỏ không quàng khăn màu đỏ và Cám là một người em tốt của Tấm, thì lô-gích mới ngừng là một môn phức tạp và bộ não Ê-mô-ri mới được giải phóng.'';
    \item ``Đế quốc Mĩ đã rất nhiều lần lên kế hoạch ngăn chặn Việt Nam thống nhất, nhưng, bởi vi dân tộc ta có một tinh thần đoàn kết vững mạnh, quân đội được xây dựng thành lực lượng hùng mạnh, và sự lãnh đạo của Đảng đầy sáng suốt, đất nước chúng ta đã có thống nhất, độc lập, tự do như ngày hôm nay.''.
\end{enumerate}
...
\begin{center}
    ``Nếu ngày mai trời mua thì Da-đê-en không đi dã ngoại.''\footnote{Đây không phải là cách hiểu duy nhất. Nhắc lại, ngôn ngữ chỉ là phương tiện, không phải luật lệ chính xác.}.
\end{center}
Kí hiệu các mệnh đề con:
\begin{itemize}
    \item $P$: ``Ngài mai trời mưa.'';
...
\begin{itemize}
    ...
    \item $E$: ``Bộ não của Ê-mô-ri mới được giải phóng.'';
\end{itemize}
