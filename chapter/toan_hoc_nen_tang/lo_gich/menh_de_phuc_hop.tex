...
Bảng \ref{tab:toan_hoc_nen_tang:lo_gich:menh_de_phuc_hop:dn_keo_theo} cũng đề cập đến một phép lô-gích nữa, chính là phép \defText{hệ quả}. Khi nói ``$P$ suy ra $Q$'', cũng có thể nói ``$Q$ là hệ quả của $P$'' trong trường hợp đó.
...
\begin{table}[H]
   \centering
   \caption{Bảng giá trị chân lí của $\overline{P \implies Q} \iff \left(\neg Q \implies \neg P\right)$}
   \begin{tabular}{|c|c|cccccccccc!{\vrule width 1.5pt}c|}
      \hline
      $P$ & $Q$ & $\neg$ & $(P$ & $\implies$ & $Q)$ & $\iff$ & $\impliedby$
   \end{tabular}
\end{table}