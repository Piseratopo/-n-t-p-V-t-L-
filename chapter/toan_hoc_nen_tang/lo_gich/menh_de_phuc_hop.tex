...
\end{itemize} Cho nên, khi viết các mệnh để phức hợp dưới dạng biểu thức, không nên coi thứ tự được đưa ra ở đây như một chân lí và bỏ qua những dấu ngoặc cần thiết, nhưng cũng không nên lạm dụng dấu ngoặc tránh gây khó đọc.}. Ví dụ:
\begin{itemize}
...
\stepcounter{subexercise}
\arabic{subexercise}. Do giới hạn của khổ giấy, bảng giá trị chân lí \ref{tab:toan_hoc_nen_tang:lo_gich:menh_de_phuc_hop:vd_bang_gia_tri_chan_li_6} sẽ được tách làm hai phần.
\begin{table}[H]
   \centering
...
\exercise[ex:toan_hoc_nen_tang:lo_gich:menh_de_phuc_hop:tc_lo_gich] Gọi $\mathbf{V}$ là một mệnh đề đúng và $\mathbf{M}$ là một mệnh đề sai nào đó. Sử dụng bảng giá trị chân lí, chứng minh các mệnh đề sau luôn đúng\footnote{Mệnh đề luôn đúng còn được gọi là \defText{mệnh đề hằng đúng}.} với mọi giá trị chân lí của $P$, $Q$ và $R$.
\begin{itemize}
...
\solution[ex:toan_hoc_nen_tang:lo_gich:menh_de_phuc_hop:tc_lo_gich]
