...
\newcommand{\notimplies}{\text{\ \  $\not$ \hspace{-1em}$\implies$}}
\newcommand{\notimpliedby}{\text{\hspace{0.9em}$\not$\hspace{-0.9em}$\impliedby$}}
...
Ngược lại của mệnh đề hội $P \land Q$ là mệnh đề \defText{phủ định hội} $\defMath{P \uparrow Q}$. Mệnh đề này chỉ \emph{sai} khi và chỉ khi $P$ và $Q$ \emph{đều đúng}.
\begin{table}[H]
   \centering
