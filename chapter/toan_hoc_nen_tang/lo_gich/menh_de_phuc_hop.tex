...
\begin{itemize}
   ...
   \item Phép \defText{phủ định kéo theo} -- $\defMath{\nRightarrow}$ hoặc $\defMath{\text{\hspace{0.6em}$\not$\hspace{-0.75em}$\implies$}}$, $\defMath{\not\rightarrow}$;
   \item Phép \defText{phủ định hệ quả} -- $\defMath{\nLeftarrow}$ hoặc $\defMath{\defMath{\text{\hspace{0.8em}$\not$\hspace{-0.94em}$\impliedby$}}}$, $\defMath{\not\leftarrow}$;
   \item Phép \defText{phủ định đẳng giá} -- $\defMath{\nLeftrightarrow}$ hoặc $\defMath{\text{\hspace{0.8em}$\not$\hspace{-0.94em}$\iff$}}$, $\defMath{\not\leftrightarrow}$; 
   \item Phép \defText{tuyển chọn} hoặc phép \defText{tuyển lại trừ} -- $\defMath{\oplus}$ hoặc $\defMath{\veebar}$, $\defMath{\not \leftrightarrow}$, $\defMath{\not\equiv}$;
...
Phép kết nối xét theo chiều ngược lại của phép kéo theo chính là phép hệ quả. Tương tự như phép kéo theo, mệnh đề \defText{hệ quả} $\defMath{P \impliedby Q}$ chỉ sai khi $P$ không được kéo theo từ $Q$ như được thể hiện ở bảng \ref{tab:toan_hoc_nen_tang:lo_gich:menh_de_phuc_hop:dn_he_qua}.
\begin{table}[H]
   \centering
...
Phép này đại diện cho sự ``cùng tiến, cùng lùi''. Mệnh đề có chứa phép \defText{đẳng giá} $\defMath{P \iff Q}$ đúng khi và chỉ khi cả hai mệnh đề con cấu thành $P$ và $Q$ cúng đúng hoặc cùng sai.
\begin{table}[H]
   \centering
