...
\begin{multicols}{2}
   \begin{enumerate}
      ...
      \item $\left((P \implies Q) \implies R\right)$ \\ 
      $\iff \left(P \implies (Q \implies R)\right)$;
      \item $P \uparrow ( Q \downarrow \neg P )$;
      \item $Q \impliedby R \odot \neg P \land Q$;
      \item $P \nLeftarrow Q \nRightarrow R \nLeftarrow Q \nRightarrow R$;
      \item $P \oplus Q \lor R \nLeftrightarrow (Q \downarrow R) \land (P \downarrow R)$.
   \end{enumerate}
\end{multicols}
...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|ccccccc!{\vrule width 1.5pt}c|}
		\hline
		P & Q & $(P$ & $\implies$ & $Q)$ & $\iff$ & $(Q$ & $\implies$ & $P)$ & $( P \implies Q ) \iff ( Q \implies P )$ \\
		\headerDivider
		Đ & Đ & Đ & Đ & Đ & \emphcolor{Đ} & Đ & Đ & Đ & Đ \\
		Đ & S & Đ & S & S & \emphcolor{S} & S & Đ & Đ & S \\
		S & Đ & S & Đ & Đ & \emphcolor{S} & Đ & S & S & S \\
