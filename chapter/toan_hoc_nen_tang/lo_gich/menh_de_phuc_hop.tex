...
\begin{itemize}
   \item Phép \defText{đối} --- $\defMath{\neg}$, $\defMath{\sim}$, $\defMath{'}$, $\defMath{!}$;
...
\begin{itemize}
   \item Phép \defText{phủ định hội} -- $\defMath{\overline{\land}}$ hoặc $\defMath{\uparrow}$;
   \item Phép \defText{phủ định tuyển} -- $\defMath{\overline{\lor}}$ hoặc $\defMath{\downarrow}$; 
   \item Phép \defText{hệ quả} -- $\defMath{\impliedby}$ hoặc $\defMath{\Leftarrow}$, $\defMath{\leftarrow}$;
   \item Phép \defText{phủ định kéo theo} -- \ \  $\defMath{\not}$ \hspace{-1em}$\defMath{\implies}$ hoặc $\defMath{\nRightarrow}$, $\defMath{\not\rightarrow}$;
   \item Phép \defText{phủ định hệ quả} -- \ \  $\defMath{\not}$ \hspace{-1em}$\defMath{\impliedby}$ hoặc $\defMath{\nLeftarrow}$, $\defMath{\not\leftarrow}$;
   \item Phép \defText{tuyển chọn} -- $\defMath{\oplus}$ hoặc $\defMath{\veebar}$, $\defMath{\not \leftrightarrow}$, $\defMath{\not\equiv}$;
...
Giả sử rằng bạn đọc thấy bữa ăn buổi hôm nay rất ngon, do sự nhiệt tình của bạn bồi bàn. Bạn đọc đã vào được phần mềm ngân hàng của mình và định cho bo cho bồ bàn một chút tiền. Tuy nhiên, bạn đọc lại nhìn thấy bảng ghi chính sách của quán: "Khách hàng không được phép đưa tiền bo cho nhân viên của quán". Nếu bạn đọc vừa $P$: là khách hàng của quán, và $Q$: đưa tiền bo cho nhân viên, thì bạn đọc đã vi phạm chính sách rằng \emphcolor{không $P$ và $Q$}. Bạn đọc đành đưa ra đề nghị với nhà hàng là bạn muốn được phục vụ lại bởi bồi bàn này trong những lần sau.
...
Bảng \ref{tab:toan_hoc_nen_tang:lo_gich:menh_de_phuc_hop:dn_keo_theo} cũng đề cập đến một phép lô-gích nữa, chính là phép hệ quả. Tương tự như phép kéo theo, mệnh đề \defText{hệ quả} $\defMath{P \impliedby Q}$ chỉ sai khi $P$ không được kéo theo từ $Q$ như được thể hiện ở bảng \ref{tab:toan_hoc_nen_tang:lo_gich:menh_de_phuc_hop:dn_he_qua}.
\begin{table}[H]
   \centering
...
Đảo của phép kéo theo và phép hệ quả, \defText{phủ định kéo theo} $\defMath{P \notimplies Q}$ và \defText{phủ định hệ quả} $\defMath{P \notimpliedby Q}$ có bảng giá trị chân lí như ở bảng \ref{tab:toan_hoc_nen_tang:lo_gich:menh_de_phuc_hop:dn_phu_dinh_keo_theo_he_qua}.
\begin{table}[H]
   \centering
...
Mệnh đề có chứa phép \defText{đẳng giá} $\defMath{P \iff Q}$ đúng khi và chỉ khi cả hai mệnh đề con cấu thành $P$ và $Q$ cúng đúng hoặc cùng sai.
\begin{table}[H]
   \centering
...
Trong một trường hợp khác, hai mệnh đề $P$ và $Q$ có một và chỉ một mệnh đề đúng là đồng nghĩa với mệnh đề \defText{tuyển chọn} $\defMath{P \oplus Q}$ đúng.
