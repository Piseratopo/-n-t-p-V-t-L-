...
\subsection{Thứ tự các phép nối}

\ % Lùi đầu dòng

Giống như thứ tự các phép tính số học\footnote{[\dots], thứ mà con người phát minh ra [\dots]}, các phép nối lô-gích cũng có sắp xếp thứ tự\footnote{[\dots]và vẫn chưa có sự thống nhất[\dots]} như sau
