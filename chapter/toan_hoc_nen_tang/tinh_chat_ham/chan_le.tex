   ...
   \begin{minipageindent}{0.48\textwidth}
      \begin{figure}[H]
         ...
         \begin{tikzpicture}
            ...
            \draw[graph thickness, samples=80, color=colorEmphasisCyan, domain=-1.526:-0.850] plot (\x, {((((\x)/1)^3 - 1/((\x)/1)^3) / (((\x)/1) + 1/((\x)/1))) / 0.25});
            \draw[graph thickness, samples=80, color=colorEmphasisCyan, domain=0.850:1.526] plot (\x, {((((\x)/1)^3 - 1/((\x)/1)^3) / (((\x)/1) + 1/((\x)/1))) / 0.25});
         \end{tikzpicture}
