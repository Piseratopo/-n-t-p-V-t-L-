...
Tiên đề cuối cùng là nền tảng cho phép chứng minh \defText{quy nạp}. Nếu $n = 0$ thỏa mãn một mệnh đề $Q(0)$ nào đó và nếu giả sử $Q(n)$ đúng suy ra $Q(s(n))$ cũng đúng thì $Q(n)$ đúng với mọi số tự nhiên $n$.