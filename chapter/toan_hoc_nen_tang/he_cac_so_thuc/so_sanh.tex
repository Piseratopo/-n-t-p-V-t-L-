...
\exercise Cho $w, x, y, z \in \mathbb{R}$ thỏa mãn $\begin{cases}
   0 \le w \le y \\
   0\le x \le z
\end{cases}$. Chứng minh rằng $wx \le yz$.
...
\end{cases}\implies \begin{cases}
   wx \leq yx \\
   xy \leq zy
\end{cases} \implies wx \le yz.$$ Chúng ta có điều phải chứng minh.

\exercise Cho $x, y$ là số thực và $z$ là một số thực âm. Chứng minh nếu $x \leq y$ thì $xz \geq yz$.
