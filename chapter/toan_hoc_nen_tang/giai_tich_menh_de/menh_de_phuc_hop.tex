...
Mệnh đề này có tính "khắt khe": nó chỉ đúng khi cả $P$ và $Q$ đồng thời cùng đúng. Nếu ít nhất một trong hai mệnh đề thành phần bị sai, kết quả của phép hội sẽ là sai, thể hiện dưới dạng bảng giá trị chân lí \ref{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_hoi}.
\begin{table}[H]
   \centering
   \caption{Bảng giá trị chân lí của mệnh đề với phép hội}
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_hoi}
...
\begin{table}[H]
   ...
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_phu_dinh_hoi}
   \begin{tabular}{|c|c!{\vrule width 1.5pt}c|}
      \hline 
      $P$ & $Q$ & $P \uparrow Q$ \\
      \headerDivider
...
Mệnh đề phức ``$P$ tuyển $Q$'' có kí hiệu $\defMath{P \lor Q}$. Mệnh đề này đúng khi tối thiểu một trong hai mệnh đề đầu vào đúng, và chỉ sai khi cả hai mệnh đề đầu vào đều sai. Bảng \ref{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_tuyen} cho giá trị chân lí của mệnh đề tuyển.
\begin{table}[H]
   \centering
   \caption{Bảng giá trị chân lí của mệnh đề với phép tuyển}
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_tuyen}
   \begin{tabular}{|c|c!{\vrule width 1.5pt}c|}
      \hline
      $P$ & $Q$ & $P \lor Q$ \\
      \headerDivider
...
\begin{table}[H]
   ...
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_phu_dinh_tuyen}
   \begin{tabular}{|c|c!{\vrule width 1.5pt}c|}
      \hline
      $P$ & $Q$ & $P \downarrow Q$ \\
      \headerDivider
...
Phép kết nối xét theo chiều ngược lại của phép kéo theo chính là phép hệ quả. Tương tự như phép kéo theo, mệnh đề hệ quả $\defMath{P \impliedby Q}$ chỉ sai khi $P$ không được kéo theo từ $Q$ như được thể hiện ở bảng \ref{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_he_qua}.
\begin{table}[H]
   \centering
   \caption{Bảng giá trị chân lí của mệnh đề với phép hệ quả}
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_he_qua}
   \begin{tabular}{|c|c!{\vrule width 1.5pt}c|}
      \hline
      $P$ & $Q$ & $P \impliedby Q$ \\
      \headerDivider
...
Đảo của phép kéo theo và phép hệ quả, phủ định kéo theo $\defMath{P \nRightarrow Q}$ và \defText{phủ định hệ quả} $\defMath{P \nLeftarrow Q}$ có bảng giá trị chân lí như ở bảng \ref{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_phu_dinh_keo_theo_he_qua}.
\begin{table}[H]
   \centering
   \caption{Bảng giá trị chân lí của mệnh đề với phép phủ định kéo theo và phủ định hệ quả}
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_phu_dinh_keo_theo_he_qua}
...
\begin{table}[H]
   ...
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_tuong_duong}
   \begin{tabular}{|c|c!{\vrule width 1.5pt}c|}
      \hline
      $P$ & $Q$ & $P \iff Q$ \\
      \headerDivider 
...
\begin{table}[H]
   \centering
   \caption{Bảng giá trị chân lí của mệnh đề với phép đẳng giá}
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_phu_dinh_dang_gia}
   \begin{tabular}{|c|c!{\vrule width 1.5pt}c|}
      \hline
      $P$ & $Q$ & $P \nLeftrightarrow Q$ \\
      \headerDivider 
...
\begin{table}[H]
   ...
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_tuyen_chon}
   \begin{tabular}{|c|c!{\vrule width 1.5pt}c|}
      \hline
      $P$ & $Q$ & $P \oplus Q$ \\
      \headerDivider 
...
\begin{table}[H]
   ...
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:dn_phu_dinh_tuyen_chon}
   \begin{tabular}{|c|c!{\vrule width 1.5pt}c|}
      \hline
      $P$ & $Q$ & $P \odot Q$ \\
      \headerDivider 
...
\begin{minipage}[c]{0.35\linewidth}
   ...
   \ref{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:vd_bang_gia_tri_chan_li_1}. 
...
\begin{minipage}[c]{0.6\linewidth}
   \begin{table}[H]
      ...
      \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:vd_bang_gia_tri_chan_li_1}
...
\end{itemize}
Ví dụ như ở bảng \ref{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:vd_bang_gia_tri_chan_li_3}, nhận thấy rằng khi $P$ sai thì mệnh đề phức hợp luôn sai, nên các cột $Q$ và $R$ và những cột có phần mệnh đề liên quan đến hai mệnh đề này ở hàng thứ năm được thay bởi những chữ $X$.
\begin{table}[H]
   \centering
   \caption{Bảng giá trị chân lí của $P \land (Q \implies R)$}
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:vd_bang_gia_tri_chan_li_3}
...
\stepcounter{subexercise}
\arabic{subexercise}. Do giới hạn của khổ giấy, bảng giá trị chân lí \ref{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:vd_bang_gia_tri_chan_li_6} sẽ được tách làm hai phần.
\begin{table}[H]
   \centering
   \caption{Bảng giá trị chân lí của $(P \implies Q) \implies (R \implies Q \implies R) $}
   \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:vd_bang_gia_tri_chan_li_6}
...
\exercise[ex:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:tc_giai_tich_menh_de] Gọi $\mathbf{V}$ là một mệnh đề đúng và $\mathbf{M}$ là một mệnh đề sai nào đó. Sử dụng bảng giá trị chân lí, chứng minh các mệnh đề sau luôn đúng\footnote{Mệnh đề luôn đúng còn được gọi là \defText{mệnh đề hằng đúng}.} với mọi giá trị chân lí của $P$, $Q$ và $R$.
\begin{itemize}
...
\solution[ex:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:tc_giai_tich_menh_de]
