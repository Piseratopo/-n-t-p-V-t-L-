...
\begin{center}
    ...
    \end{tabular}.
\end{center}
Mệnh đề mà chúng ta cần khẳng định đúng để hoàn thành chứng minh là $(P \implies Q) \land P \implies Q$. Thực vậy, có bảng \ref{tab:toan_hoc_nen_tang:giai_tich_menh_de:lap_luan:vd_chung_minh}.
    
\begin{table}[H]
    \centering
    \caption{Bảng giá trị chân lí của $( P \implies Q ) \land P \implies Q$}
    \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:lap_luan:vd_chung_minh}
...
Để thuận tiện cho việc lập luận, sẽ sử dụng các kết quả đã có của bài \ref{ex:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:tc_giai_tich_menh_de} ở trang \pageref{ex:toan_hoc_nen_tang:giai_tich_menh_de:menh_de_phuc_hop:tc_giai_tich_menh_de}.
...
Qua đó, chúng ta có điều phải chứng minh. Bạn đọc cũng có thể thực hiện bài tập này thông qua bảng giá trị chân lí, nhưng khí đó, bạn đọc sẽ phải xét\dots\ mà thôi, bạn đọc có thể tham khảo bảng \ref{ex:toan_hoc_nen_tang:giai_tich_menh_de:lap_luan:bai_2_phan_4} nếu bạn đọc không muốn phải ghét bản thân như tác giả đã từng khi thực hiện lập bảng này\footnote{Bạn đọc có thể kiểm tra lại bảng \ref{ex:toan_hoc_nen_tang:giai_tich_menh_de:lap_luan:bai_2_phan_4} để trải nghiệm cảm giác của tác giả lúc viết đáp án. Khi càng tăng nhiều biến thì số trường hợp cần phải kiểm tra cũng tăng theo theo cấp số nhân.}. Ngoài ra, bạn đọc cũng sẽ mất đi cơ hội được thường thức nghệ thuật của sự lập luận do bị thay thế bởi sự cơ học của phương pháp.

\begin{table}[H]
    \centering
	\caption{Bảng giá trị chân lí của $( L \land P \implies N ) \land ( N \lor I \implies \neg R ) \land ( \neg P \implies R ) \land ( \neg I \land \neg R ) \implies P$}
    \label{ex:toan_hoc_nen_tang:giai_tich_menh_de:lap_luan:bai_2_phan_4}
...
Lập luận được kiểm tra lại bằng bảng giá trị chân lí \ref{tab:toan_hoc_nen_tang:giai_tich_menh_de:lap_luan:xor_va_nxor}.

\begin{table}[H]
	\centering
	\caption{Bảng giá trị chân lí của $( P \oplus Q ) \land ( P \odot Q )$}
    \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:lap_luan:xor_va_nxor}
...
\stepcounter{subexercise}
\arabic{subexercise}. Bảng \ref{tab:toan_hoc_nen_tang:giai_tich_menh_de:lap_luan:xor_nxor_tuong_duong_hon_hop} cho thấy rằng giả thiết luôn mâu thuẫn.
\begin{table}[H]
	\centering
	\caption{Bảng giá trị chân lí của $( A \odot B ) \land ( B \oplus C ) \land ( C \odot D ) \land ( D \iff A )$}
    \label{tab:toan_hoc_nen_tang:giai_tich_menh_de:lap_luan:xor_nxor_tuong_duong_hon_hop}
