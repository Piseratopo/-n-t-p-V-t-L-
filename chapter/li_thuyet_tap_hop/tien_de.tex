...
$$
\defMath{\forall x, \forall y, \left( x = y \iff \left( \forall z, \left( z \in x \iff z \in y \right) \right) \right)}.
$$
...
$$
\defMath{\forall x, \forall y, \left( x \subseteq y \iff \left( \forall z, \left( z \in x \implies z \in y \right) \right) \right)}.
$$
...
$$
Tập này được gọi là \defText{tập rỗng} và được kí hiệu là $\defMath{\emptyset}$.