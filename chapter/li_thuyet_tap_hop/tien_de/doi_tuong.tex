...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \node[element alert, label={[red]left:$z$}] (x_out) at (3.5, 1.5) {};
        \draw[thick, red, dashed] (x_out) to[bend left=135] (2.5, 0);
        \draw[guide arrow, red, dashed] (2.5, 0) to[bend left=-45] (1.5, 0);
    \end{tikzpicture}
