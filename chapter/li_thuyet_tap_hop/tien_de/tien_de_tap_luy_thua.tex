...
\arabic{subexercise}. Có tập rỗng là tập con của mọi tập hợp. Cho nên $\emptyset \subseteq X$. Nhắc lại định nghĩa của tập lũy thừa, $\mathfrak{P}(X)$ là tập chứa tất cả các tập con của $X$. Do đó, $\emptyset \in \mathfrak{P}(X)$. Điều phải chứng minh.
