...
$$
với $V$ là vị từ. Dưới dạng ngôn ngữ tự nhiên, chúng ta sẽ nói:
\begin{center}
...
\end{equation*}
Đây được gọi là \defText{giao} của $x$ và $y$, kí hiệu $\defMath{x \cap y}$. Có $z \in y$, thì chúng ta cũng có thể có \defText{hiệu} giữa $x$ và $y$ như sau:
\begin{equation*}
    \defMath{x \setminus y} = \defMath{\{ z \in x \mid z \notin y \}}.
\end{equation*}